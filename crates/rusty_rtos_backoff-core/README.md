...
[![crates.io](https://img.shields.io/crates/v/rusty_rtos_backoff-core.svg)](https://crates.io/crates/rusty_rtos_backoff-core)
[![docs.rs](https://docs.rs/rusty_rtos_backoff-core/badge.svg)](https://docs.rs/rusty_rtos_backoff-core)
[![license](https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue.svg)](#license)

The pure `no_std` core of [`rusty_rtos_backoff`](https://github.com/Remade-With-Rust/rusty_rtos_backoff):
exponential backoff with jitter, the Kairos remake of FreeRTOS's
`backoffAlgorithm`. No CPU, no allocator, no operating system.
`#![forbid(unsafe_code)]`.
