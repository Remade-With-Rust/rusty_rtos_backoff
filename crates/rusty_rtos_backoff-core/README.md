...
The pure `no_std` core of [`rusty_rtos_backoff`](https://crates.io/crates/rusty_rtos_backoff):
...
Part of Kairos (Remade With Rust). Plan: `docs/plans/rusty_rtos_backoff.md` in the repo.
