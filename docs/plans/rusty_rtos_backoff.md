# rusty_rtos_backoff — package plan

**One sentence:** backoffAlgorithm remade in Rust: exponential backoff with jitter for network retries, no_std, forbid(unsafe), gated against the C library's own test vectors.
